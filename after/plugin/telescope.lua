...
vim.keymap.set('n', '<leader>fs', builtin.spell_suggest,
  { desc = "Lists spelling suggestions for the current word under the cursor, replaces word with selected suggestion" })
...
vim.keymap.set('n', '<leader><leader>', custom.project_files,
